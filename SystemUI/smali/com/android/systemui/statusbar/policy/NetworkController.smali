...
.field private static final FLIGHT_MODE_ICON:I = 0x7f0201a8
...
.field private mIMSRegistrationStatusString:Ljava/lang/String;

.field private mIMSRegistrationString:Ljava/lang/String;
...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lcom/android/systemui/statusbar/policy/NetworkController;->initializeCodeToState()Ljava/util/HashMap;

    move-result-object v0

    sput-object v0, Lcom/android/systemui/statusbar/policy/NetworkController;->sCodeToState:Ljava/util/HashMap;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-boolean v9, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mShowLAC:Z

    iput v8, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mDataServiceState:I

    iput-boolean v9, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mIMSRegistered:Z

    iput-object v6, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mIMSRegistrationString:Ljava/lang/String;

    iput-object v6, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mIMSRegistrationStatusString:Ljava/lang/String;

    iput v9, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLinkStatus:I

    const-string v5, ""

    iput-object v5, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastSsid:Ljava/lang/String;

    const-string v5, ""

    iput-object v5, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastBssid:Ljava/lang/String;

    iput v9, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastFreq:I
    ...
    sget-boolean v5, Lcom/android/systemui/statusbar/Feature;->m4GDataDistinguishable:Z
...
.method private checkCarrierWifiIcon()V
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/statusbar/policy/NetworkController;->isKTWifi(Ljava/lang/String;)Z
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/NetworkController;->getKTWifiIcon()[[I

    move-result-object v4

    iput-object v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mWifiCarrierIcon:[[I
    ...
    invoke-direct {p0, v3}, Lcom/android/systemui/statusbar/policy/NetworkController;->isLGTWifi(Ljava/lang/String;)Z

    move-result v4

    if-eqz v4, :cond_1

    invoke-direct {p0, v2}, Lcom/android/systemui/statusbar/policy/NetworkController;->getLGTWifiIcon(I)[[I
...
.method private checkWifiLinkRoamingStatus()V
    .locals 6
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastSsid:Ljava/lang/String;
    ...
    iget-object v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastBssid:Ljava/lang/String;
    ...
    :cond_2
    iget v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastFreq:I
    ...
    const-string v5, "wifi roaming is occured"

    invoke-static {v4, v5}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    iget-object v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mWifiManager:Landroid/net/wifi/WifiManager;

    invoke-virtual {v4}, Landroid/net/wifi/WifiManager;->getLinkStatus()I

    move-result v4

    and-int/lit8 v4, v4, 0x3

    iput v4, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLinkStatus:I
    ...
    :cond_4
    :goto_1
    iput-object v2, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastSsid:Ljava/lang/String;

    iput-object v0, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastBssid:Ljava/lang/String;

    iput v1, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLastFreq:I
...
.method private getAreaInfo()Ljava/lang/String;
    ...
    invoke-direct {p0, v2, v0}, Lcom/android/systemui/statusbar/policy/NetworkController;->setAreaCode(Landroid/telephony/TelephonyManager;Ljava/lang/StringBuilder;)V
    :try_end_0
...
.method private getDimmedLTEBoosterDataTypeIcon()I
    ...
    iget-boolean v1, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mCAIndicator:Z
    ...
    :cond_2
    sget-boolean v1, Lcom/android/systemui/statusbar/Feature;->m4GDataDistinguishable:Z
...
.method private final getRoamingIcon()V
    ...
    const-string v5, "NoService, mRoamingIconId = 0"
    ...
    const-string v6, "isCdma(), isCdmaEri(), mRoamingIconId = getCdmaEriIcon() : "
    ...
    const-string v5, "isCdma(), !isCdmaEri(), mRoamingIconId = 0"
    ...
    sget-boolean v4, Lcom/android/systemui/statusbar/Feature;->mRoamingIconDisplay:Z
    ...
    sget-boolean v4, Lcom/android/systemui/statusbar/Feature;->mRoamingIconForJPN:Z
    ...
    const-string v6, "mPhone.isNetworkRoaming(), DeviceType != 1, mRoamingIconId : "
    ...
    const-string v5, "Nothing, mRoamingIconId = 0"
...
.method private getUpdateDataNetType()V
    ...
    :cond_7
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/NetworkController;->updateLTE4GICONDataNetType()V
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/NetworkController;->updateZVVLACInfo()V
...
.method private refreshNwBoosterIndicator(Lcom/android/systemui/statusbar/policy/NetworkController$SignalCluster;)V
    ...
    iget v0, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLinkStatus:I
    ...
    :pswitch_1
    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->NWBOOSTER_WIFI_SIGNAL_STRENGTH_AC:[[I
    ...
    :pswitch_2
    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->NWBOOSTER_WIFI_SIGNAL_STRENGTH_MIMO:[[I
    ...
    :pswitch_3
    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->NWBOOSTER_WIFI_SIGNAL_STRENGTH_AC_MIMO:[[I
...
.method private setAreaCode(Landroid/telephony/TelephonyManager;Ljava/lang/StringBuilder;)V
    ...
    sget-object v4, Lcom/android/systemui/statusbar/policy/NetworkController;->sCodeToState:Ljava/util/HashMap;
...
.method private final updateAIODataNetType()V
    ...
    :pswitch_4
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mCAIndicator:Z
...
.method private final updateDataNetType()V
    ...
    sget-object v1, Lcom/android/systemui/statusbar/policy/TelephonyIcons;->DATA_4G_PLUS:[[I
...
.method private updateNoSIMNotification()V
    ...
    const-string v7, "do not show no sim notifiation"
    ...
    :cond_1
    sget-boolean v6, Lcom/android/systemui/statusbar/Feature;->mSimIconForCHN:Z
    ...
    sget-boolean v6, Lcom/android/systemui/statusbar/Feature;->mUseVzwSimIcon:Z
    ...
    const-string v6, "android.intent.action.SIM_TYPE_POPUP"

    invoke-direct {v2, v6}, Landroid/content/Intent;-><init>(Ljava/lang/String;)V

    const-string v6, "SIM_TYPE"

    const-string v7, "NO_SIM"
    ...
    :cond_4
    sget-boolean v6, Lcom/android/systemui/statusbar/Feature;->mNoSIMNotificationForTMO:Z
...
.method private updateRoamingNotification()V
    ...
    const-string v6, "updateRomaingNotification cancel"
    ...
    const-string v8, "updateRomaingNotification Type : "
    ...
    const-string v7, " mDataRoamingTypeForVZW : "

    invoke-virtual {v6, v7}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v6

    iget v7, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mDataRoamingTypeForVZW:I
...
.method private final updateTMODataNetType()V
    ...
    iput v8, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mNwboosterDataTypeIconId:I
    ...
    :cond_2
    iput-boolean v5, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mDataTypeTMOstyle:Z
    ...
    const-string v3, "updateDataNet R -"
    ...
    sget-object v1, Lcom/android/systemui/statusbar/policy/TelephonyIcons;->DATA_TMO:[[I
...
.method private final updateTelephonySignalStrength()V
    ...
    iget-object v3, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mOperator:Ljava/lang/String;

    invoke-static {v3}, Lcom/android/systemui/statusbar/policy/NetworkController$Operator;->getOperatorFromString(Ljava/lang/String;)Lcom/android/systemui/statusbar/policy/NetworkController$Operator;

    move-result-object v3

    sget-object v4, Lcom/android/systemui/statusbar/policy/NetworkController$Operator;->TMO:Lcom/android/systemui/statusbar/policy/NetworkController$Operator;
    ...
    invoke-direct {p0, v3, v5}, Lcom/android/systemui/statusbar/policy/NetworkController;->getDataSignalIconId(II)I
...
.method private updateWifiIcons()V
    ...
    const-string v1, "WifiType default - do nothing"
    ...
    const-string v1, "WifiType neither 802.11AC nor MIMO - do nothing"
    ...
    const-string v1, "WifiType 802.11AC detected"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->WIFI_SIGNAL_STRENGTH_AC:[[I
    ...
    const-string v1, "WifiType MIMO detected"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->WIFI_SIGNAL_STRENGTH_MIMO:[[I
    ...
    const-string v1, "WifiType both 802.11AC and MIMO detected"

    invoke-static {v0, v1}, Landroid/util/Slog;->d(Ljava/lang/String;Ljava/lang/String;)I

    sget-object v0, Lcom/android/systemui/statusbar/policy/WifiIcons;->WIFI_SIGNAL_STRENGTH_AC_MIMO:[[I
...
.method private updateWifiState(Landroid/content/Intent;)V
    ...
    iput v5, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLinkStatus:I
...
.method private final updateZVVLACInfo()V
    ...
    iput-boolean v2, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mShowLAC:Z
    ...
    invoke-direct {p0}, Lcom/android/systemui/statusbar/policy/NetworkController;->getAreaInfo()Ljava/lang/String;
...
.method public onReceive(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    iput-boolean v0, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mCAIndicator:Z
    ...
    const-string v2, "onReceive() - LTE_WIDEBAND_INFO with extra :: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mCAIndicator:Z
    ...
    const-string v2, "onReceive() - LTE_WIDEBAND_INFO without extra :: "
    ...
    const-string v1, "LTE_WIDEBAND_INFO - Change to 4G+ !!!"
    ...
    iget-boolean v0, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mShowLAC:Z
    ...
    const-string v1, "onReceive() - WifiManager.SUPPLICANT_STATE_CHANGED_ACTION"
...
.method public refreshSignalCluster(Lcom/android/systemui/statusbar/policy/NetworkController$SignalCluster;)V
    ...
    sget-object v2, Lcom/android/systemui/statusbar/policy/NetworkController$Operator;->TMO:Lcom/android/systemui/statusbar/policy/NetworkController$Operator;
    ...
    const-string v2, "refreshSignalCluster no data icon"
...
.method refreshViews()V
    ...
    sget-object v17, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegistrationStateContract$State;->REGISTERED:Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegistrationStateContract$State;
    ...
    invoke-static/range {v18 .. v18}, Lcom/samsung/tmowfc/wfcutils/WfcDbHelper;->getRegistrationState(Landroid/content/ContentResolver;)Lcom/samsung/tmowfc/wfcutils/WfcDbHelper$RegistrationStateContract$State;
    ...
    iget v0, v0, Lcom/android/systemui/statusbar/policy/NetworkController;->mLinkStatus:I
    ...
    invoke-direct/range {p0 .. p0}, Lcom/android/systemui/statusbar/policy/NetworkController;->getKTWifiActivityIcon()I
...
.method updateNetworkName(ZLjava/lang/String;ZLjava/lang/String;)V
    ...
    :cond_a
    iget-boolean v2, p0, Lcom/android/systemui/statusbar/policy/NetworkController;->mShowLAC:Z
