...
.method public getCSCPackageItemText(Ljava/lang/String;)Ljava/lang/CharSequence;
    ...
    const-string v9, "com.android.stk.StkLauncherActivity1"
    ...
    const-string v9, "com.sec.android.app.latin.launcher.stk"
    ...
    const-string v9, "com.sec.android.app.latin.launcher.stk.StkShortcutWidget"
    ...
    const-string v9, "gsm.STK_SETUP_MENU"
    ...
    :cond_5
    const-string v9, "com.android.stk2"
    ...
    const-string v9, "com.android.stk2.StkLauncherActivity2"
    ...
    const-string v9, "com.android.stk2.StkLauncherActivity"
    ...
    :cond_7
    const-string v9, "gsm.STK_SETUP_MENU2"
    ...
    iget-object v9, v9, Landroid/app/ContextImpl;->mMainThread:Landroid/app/ActivityThread;

    invoke-virtual {v9}, Landroid/app/ActivityThread;->getCSCAppStringMap()Landroid/util/ArrayMap;
    ...
    invoke-direct {v5, p1, v7}, Landroid/app/ApplicationPackageManager$ResourceName;-><init>(Ljava/lang/String;I)V

    invoke-direct {p0, v5}, Landroid/app/ApplicationPackageManager;->getCachedString(Landroid/app/ApplicationPackageManager$ResourceName;)Ljava/lang/CharSequence;
    ...
    invoke-virtual {v9, v10, v11, v12, v13}, Landroid/app/ActivityThread;->getTopLevelResources(Ljava/lang/String;ILandroid/content/res/Configuration;Landroid/app/LoadedApk;)Landroid/content/res/Resources;
    ...
    invoke-direct {p0, v5, v8}, Landroid/app/ApplicationPackageManager;->putCachedString(Landroid/app/ApplicationPackageManager$ResourceName;Ljava/lang/CharSequence;)V
    :try_end_0
    .catch Ljava/lang/RuntimeException; {:try_start_0 .. :try_end_0} :catch_0
