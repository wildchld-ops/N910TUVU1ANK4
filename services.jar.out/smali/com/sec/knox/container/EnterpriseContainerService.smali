...
.method private declared-synchronized decrementWakeLock()V
    ...
    const-string/jumbo v2, "refCountWakeLock before decrement: "
    ...
    const-string/jumbo v2, "refCountWakeLock after decrement: "
...
.method private declared-synchronized incrementWakeLock()V
    ...
    const-string/jumbo v2, "refCountWakeLock before increment: "
    ...
    const-string/jumbo v2, "refCountWakeLock after increment: "
...
.method private mount(Lcom/sec/knox/container/EnterpriseContainerObjectParam;III)I
    ...
    const-string/jumbo v4, "primary mount already exists for some reason, force unmount"
    ...
    const-string/jumbo v4, "primary mount is clear for mount"
...
.method private registerReceiverPerContainer(Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "registering action >> sec_container_"
...
.method private removeContainerActiveAdmin(I)V
    ...
    const-string/jumbo v11, "removeContainerActiveAdmin()"
    ...
    const-string/jumbo v12, "removeActiveAdmin called with ComponentName= "
    ...
    const-string/jumbo v12, "removeContainerActiveAdmin: no admins found in Container Id: "
...
.method private declared-synchronized resetWakeLock()V
    ...
    const-string/jumbo v2, "refCountWakeLock before reset: "
...
.method public removeContainer(ILcom/sec/enterprise/knox/IEnterpriseContainerCallback;)Z
    ...
    const-string/jumbo v4, "removeContainer() ContainerId: "
    ...
    const-string/jumbo v3, "removeContainer Failed, Reason: Invalid container state."
