...
.method public passwordHasExpired(I)Z
    ...
    const-string/jumbo v8, "passwordHasExpired(): password has expired"
    ...
    const-string/jumbo v7, "passwordHasExpired(): password still valid"
...
.method public removeActiveAdmin(Landroid/content/ComponentName;)Z
    ...
    const-string/jumbo v2, "removeActiveAdmin(): remove admin from Eccp DB succed: admin = "
    ...
    const-string/jumbo v2, "removeActiveAdmin(): remove admin from Eccp DB failed: admin = "
...
.method public removeContainer(I)Z
    ...
    const-string/jumbo v1, "removeContainer(): remove container from Eccp DB succed"
    ...
    const-string/jumbo v1, "removeContainer(): remove container from Eccp DB failed"
