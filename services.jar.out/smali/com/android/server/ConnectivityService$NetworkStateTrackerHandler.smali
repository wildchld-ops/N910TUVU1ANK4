...
.method public handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$1500(Lcom/android/server/ConnectivityService;)Landroid/content/Context;
    ...
    invoke-static {v8, v1}, Lcom/android/server/ConnectivityService;->access$1600(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)Z
    ...
    invoke-static {v8, v1}, Lcom/android/server/ConnectivityService;->access$1700(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$2200(Lcom/android/server/ConnectivityService;)Lcom/android/server/net/LockdownVpnTracker;
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$2300(Lcom/android/server/ConnectivityService;)Lcom/android/server/enterprise/billing/EnterpriseConnectivity;

    move-result-object v8

    invoke-virtual {v8, v1}, Lcom/android/server/enterprise/billing/EnterpriseConnectivity;->updateConnectivity(Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v8, v2, v5, v11}, Lcom/android/server/ConnectivityService;->access$1900(Lcom/android/server/ConnectivityService;Landroid/net/LinkProperties;Landroid/net/RouteInfo;Z)Z
    ...
    invoke-static {v8, v1}, Lcom/android/server/ConnectivityService;->access$2000(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v8, v1}, Lcom/android/server/ConnectivityService;->access$2100(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)V
    ...
    # invokes: Lcom/android/server/ConnectivityService;->handleConnect(Landroid/net/NetworkInfo;)V
    invoke-static {v9, v8}, Lcom/android/server/ConnectivityService;->access$2100(Lcom/android/server/ConnectivityService;Landroid/net/NetworkInfo;)V
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$2400(Lcom/android/server/ConnectivityService;)Lcom/sec/android/emergencymode/EmergencyManager;
    ...
    const-string v8, "ConnectivityChange EVENT_CONFIGURATION_CHANGED  Wifi skip in Emergency"
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$2500(Lcom/android/server/ConnectivityService;)[Landroid/net/LinkProperties;
    ...
    invoke-static {v8}, Lcom/android/server/ConnectivityService;->access$2600(Lcom/android/server/ConnectivityService;)Z
    ...
    invoke-static {v8, v9}, Lcom/android/server/ConnectivityService;->access$2700(Lcom/android/server/ConnectivityService;I)Z
    ...
    invoke-static {v8, v9, v10}, Lcom/android/server/ConnectivityService;->access$2800(Lcom/android/server/ConnectivityService;IZ)V
    ...
    invoke-static {v8, v9}, Lcom/android/server/ConnectivityService;->access$1400(Lcom/android/server/ConnectivityService;Landroid/net/NetworkStateTracker;)V
    ...
    invoke-static {v8, v9}, Lcom/android/server/ConnectivityService;->access$1300(Lcom/android/server/ConnectivityService;Landroid/net/NetworkStateTracker;)V
