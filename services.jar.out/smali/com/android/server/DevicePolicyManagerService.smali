...
.method private loadSettingsLocked(Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;I)Z
    ...
    const-string/jumbo v20, "policies"
    ...
    const-string/jumbo v21, "recoverable"
...
.method private saveSettingsLocked(IZ)V
    ...
    const-string/jumbo v11, "recoverable"
...
.method public isActivePasswordSufficient(I)Z
    ...
    invoke-virtual {p0, v7, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getActiveAdminForCallerLocked(Landroid/content/ComponentName;II)Lcom/android/server/DevicePolicyManagerService$ActiveAdmin;

    move-result-object v2

    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordQuality:I
    ...
    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordLength:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumLength(Landroid/content/ComponentName;I)I
    ...
    :try_start_4
    invoke-virtual {p0, v7, p1}, Lcom/android/server/DevicePolicyManagerService;->getSimplePasswordEnabled(Landroid/content/ComponentName;I)Z
    ...
    const-string v7, "isActivePasswordSufficient() : simple password is not allowed"
    ...
    const-string v8, "isActivePasswordSufficient() : fail to get isDevicePasswordSimple() due to mContext == null"
    ...
    :sswitch_1
    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordNumeric:I
    ...
    :cond_9
    :try_start_8
    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordUpperCase:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumUpperCase(Landroid/content/ComponentName;I)I

    move-result v8

    if-lt v7, v8, :cond_a

    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordLowerCase:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumLowerCase(Landroid/content/ComponentName;I)I

    move-result v8

    if-lt v7, v8, :cond_a

    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordLetters:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumLetters(Landroid/content/ComponentName;I)I
    ...
    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumNumeric(Landroid/content/ComponentName;I)I

    move-result v8

    if-lt v7, v8, :cond_a

    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordSymbols:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumSymbols(Landroid/content/ComponentName;I)I

    move-result v8

    if-lt v7, v8, :cond_a

    iget v7, v4, Lcom/android/server/DevicePolicyManagerService$DevicePolicyData;->mActivePasswordNonLetter:I

    const/4 v8, 0x0

    invoke-virtual {p0, v8, p1}, Lcom/android/server/DevicePolicyManagerService;->getPasswordMinimumNonLetter(Landroid/content/ComponentName;I)I
