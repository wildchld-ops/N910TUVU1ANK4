.class Lcom/android/phone/sip/SipEditor$4;
...
.method constructor <init>(Lcom/android/phone/sip/SipEditor;Landroid/net/sip/SipProfile;Landroid/net/sip/SipProfile;)V
    ...
    iput-object p1, p0, Lcom/android/phone/sip/SipEditor$4;->this$0:Lcom/android/phone/sip/SipEditor;

    iput-object p2, p0, Lcom/android/phone/sip/SipEditor$4;->val$newProfile:Landroid/net/sip/SipProfile;

    iput-object p3, p0, Lcom/android/phone/sip/SipEditor$4;->val$oldProfile:Landroid/net/sip/SipProfile;
...
.method public run()V
    ...
    :try_start_0
    iget-object v1, p0, Lcom/android/phone/sip/SipEditor$4;->val$newProfile:Landroid/net/sip/SipProfile;

    if-eqz v1, :cond_0

    iget-object v1, p0, Lcom/android/phone/sip/SipEditor$4;->this$0:Lcom/android/phone/sip/SipEditor;
    ...
    invoke-static {v1}, Lcom/android/phone/sip/SipEditor;->access$600(Lcom/android/phone/sip/SipEditor;)Lcom/android/phone/sip/SipEditor$PrimaryAccountSelector;
    ...
    invoke-static {v1}, Lcom/android/phone/sip/SipEditor;->access$700(Lcom/android/phone/sip/SipEditor;)V
    ...
    iget-object v2, p0, Lcom/android/phone/sip/SipEditor$4;->val$newProfile:Landroid/net/sip/SipProfile;

    invoke-virtual {v1, v2}, Lcom/android/phone/sip/SipEditor$PrimaryAccountSelector;->commit(Landroid/net/sip/SipProfile;)V

    iget-object v1, p0, Lcom/android/phone/sip/SipEditor$4;->this$0:Lcom/android/phone/sip/SipEditor;

    iget-object v2, p0, Lcom/android/phone/sip/SipEditor$4;->val$oldProfile:Landroid/net/sip/SipProfile;
    ...
    invoke-static {v1, v2}, Lcom/android/phone/sip/SipEditor;->access$900(Lcom/android/phone/sip/SipEditor;Landroid/net/sip/SipProfile;)V
    :try_end_0
    ...
    invoke-static {v1, v0}, Lcom/android/phone/sip/SipEditor;->access$1000(Lcom/android/phone/sip/SipEditor;Ljava/lang/Throwable;)V
