...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    const-string v0, "delete_prefix.db"
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string v1, "CREATE TABLE delete_prefix (_id INTEGER PRIMARY KEY AUTOINCREMENT, deleteprefix_number TEXT NOT NULL,edit_checked INTEGER NOT NULL);"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    const-string v1, "PrefixDB"

    const-string v2, "CREATE TABLE delete_prefix (_id INTEGER PRIMARY KEY AUTOINCREMENT, deleteprefix_number TEXT NOT NULL,edit_checked INTEGER NOT NULL);"
    ...
    const-string v2, "INSERT INTO delete_prefix (\'DELETEPREFIX_NUMBER\', \'EDIT_CHECKED\') values (\'"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string v0, "PrefixDB"

    const-string v1, "onUpgrade"

    invoke-static {v0, v1}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    const-string v0, "DROP TABLE IF EXISTS delete_prefix"
