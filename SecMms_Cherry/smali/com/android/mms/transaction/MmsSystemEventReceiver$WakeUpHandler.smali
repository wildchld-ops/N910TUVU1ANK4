...
.method public handleMessage(Landroid/os/Message;)V
    ...
    # setter for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->mConnMgr:Landroid/net/ConnectivityManager;
    invoke-static {v3}, Lcom/android/mms/transaction/MmsSystemEventReceiver;->access$102(Landroid/net/ConnectivityManager;)Landroid/net/ConnectivityManager;

    # getter for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->mConnMgr:Landroid/net/ConnectivityManager;
    ...
    # setter for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->waitCount:I
    invoke-static {v5}, Lcom/android/mms/transaction/MmsSystemEventReceiver;->access$202(I)I
    ...
    # invokes: Lcom/android/mms/transaction/MmsSystemEventReceiver;->wakeUpService(Landroid/content/Context;I)V
    invoke-static {v3, v2}, Lcom/android/mms/transaction/MmsSystemEventReceiver;->access$300(Landroid/content/Context;I)V
    ...
    # invokes: Lcom/android/mms/transaction/MmsSystemEventReceiver;->wakeUpService(Landroid/content/Context;)V
    invoke-static {v3}, Lcom/android/mms/transaction/MmsSystemEventReceiver;->access$400(Landroid/content/Context;)V

    goto :goto_0

    :cond_5
    # getter for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->waitCount:I
    ...
    const-string v4, "[MmsSystemEventReceiver] cannot use mobile_mms"

    invoke-static {v3, v4}, Lcom/android/mms/Log;->v(Ljava/lang/String;Ljava/lang/String;)V

    # setter for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->bExecutingEvent:Z
    invoke-static {v5}, Lcom/android/mms/transaction/MmsSystemEventReceiver;->access$502(Z)Z
    ...
    const-string v5, "[MmsSystemEventReceiver] mobile_mms is not available"

    invoke-static {v3, v5}, Lcom/android/mms/Log;->v(Ljava/lang/String;Ljava/lang/String;)V

    # operator++ for: Lcom/android/mms/transaction/MmsSystemEventReceiver;->waitCount:I
    ...
    invoke-static {v3, v5}, Lcom/android/mms/util/NetworkConnectionUtils;->isMmsNetworkAvailable(Landroid/content/Context;I)Z
