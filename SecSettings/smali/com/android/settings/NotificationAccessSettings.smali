...
.method private static getListeners(Landroid/widget/ArrayAdapter;Landroid/content/pm/PackageManager;)I
    ...
    invoke-virtual {p1, v8, v9, v7}, Landroid/content/pm/PackageManager;->queryIntentServicesAsUser(Landroid/content/Intent;II)Ljava/util/List;
    ...
    sget-object v8, Lcom/android/settings/NotificationAccessSettings;->TAG:Ljava/lang/String;

    new-instance v9, Ljava/lang/StringBuilder;

    invoke-direct {v9}, Ljava/lang/StringBuilder;-><init>()V

    const-string v10, "Skipping notification listener service "
    ...
    iget-object v10, v3, Landroid/content/pm/PackageItemInfo;->name:Ljava/lang/String;
    ...
    const-string v10, "android.permission.BIND_NOTIFICATION_LISTENER_SERVICE"
    ...
    iget-object v9, v3, Landroid/content/pm/PackageItemInfo;->name:Ljava/lang/String;

    invoke-direct {v0, v8, v9}, Landroid/content/ComponentName;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {p1, v0}, Lcom/android/settings/Utils;->isNotificationAccessSysApp(Landroid/content/pm/PackageManager;Landroid/content/ComponentName;)Z
