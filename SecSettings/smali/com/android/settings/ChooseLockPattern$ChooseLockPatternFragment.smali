...
.method public constructor <init>()V
    ...
    iput v2, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mStatusBarDisableCount:I
...
.method private saveChosenPatternAndFinish()V
    ...
    invoke-virtual {v1, v9, v2}, Landroid/content/ContextWrapper;->sendBroadcastAsUser(Landroid/content/Intent;Landroid/os/UserHandle;)V
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    iput-object v3, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mPwdPolicy:Landroid/app/enterprise/PasswordPolicy;

    :cond_0
    iget-object v3, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mPwdPolicy:Landroid/app/enterprise/PasswordPolicy;
    ...
    iget v3, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mPwdChangeEnforce:I
    ...
    check-cast v3, Lcom/android/settings/ChooseLockPattern;

    # invokes: Lcom/android/settings/ChooseLockPattern;->allowHomeAndBack(Z)V
    invoke-static {v3, v5}, Lcom/android/settings/ChooseLockPattern;->access$400(Lcom/android/settings/ChooseLockPattern;Z)V
    ...
    iget v3, v1, Landroid/content/pm/PersonaInfo;->state:I
    ...
    iput-object v3, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mStatusBarManager:Landroid/app/StatusBarManager;
    ...
    iput-object v3, p0, Lcom/android/settings/ChooseLockPattern$ChooseLockPatternFragment;->mChooseLockSettingsHelper:Lcom/android/settings/ChooseLockSettingsHelper;

    invoke-virtual {p0}, Landroid/app/Fragment;->getActivity()Landroid/app/Activity;

    move-result-object v3

    instance-of v3, v3, Lcom/android/settings/ChooseLockPattern;
