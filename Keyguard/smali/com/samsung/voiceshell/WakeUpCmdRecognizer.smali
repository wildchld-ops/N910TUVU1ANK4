...
.field public static WMode:I

.field public static WType:I
...
.method private InitSensorySession()V
    ...
    const-string v1, "InitSensorySession"
    ...
    invoke-virtual {v0}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->getSessionValue()J
    ...
    iget-object v6, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->TAG:Ljava/lang/String;

    new-instance v7, Ljava/lang/StringBuilder;

    invoke-direct {v7}, Ljava/lang/StringBuilder;-><init>()V

    const-string v8, "InitSensorySession, pre-trig : "
    ...
    iget-boolean v6, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isLockProcess:Z

    if-nez v6, :cond_0

    iget-object v6, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->mSensoryUDTSIDEngine:Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;

    invoke-virtual {v6, v0, v1}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->closeSession(J)V
    ...
    const-string v8, "InitSensorySession, pre-trigFPSV : "
    ...
    invoke-virtual {v6, v4, v5}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->closeSession(J)V
    ...
    invoke-virtual {v0}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->initSession()J
    ...
    invoke-virtual {v4, v0, v1, v2, v3}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->setSessionValue(JJ)V
    ...
    const-string v2, "secMM: SensoryUDTSIDEngine init complete, WMode : "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    sget v2, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->WMode:I
...
.method private InitializeVerify()I
    ...
    const-string v1, "InitializeVerify"
    ...
    invoke-virtual {v1, v2}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->SetWakeUpType(I)V

    :goto_0
    iget-object v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->mDummyRecorder:Lcom/samsung/voiceshell/AudioRecordHaydn;

    invoke-virtual {v1, v4}, Lcom/samsung/voiceshell/AudioRecordHaydn;->SetRecordingMode(I)V
...
.method private StartVerify()I
    ...
    sget v1, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->WType:I
    ...
    invoke-virtual {v1, v2, v6}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->loadModels(Ljava/lang/String;S)I
    ...
    invoke-virtual {v1, v2}, Lcom/samsung/voiceshell/AudioRecordHaydn;->SetRecordingMode(I)V
    ...
    invoke-virtual {v1, v2, v5}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->GetWakeUpModel(IS)Ljava/lang/String;
    ...
    invoke-virtual {v1, v2, v5}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->loadModels(Ljava/lang/String;S)I
    ...
    :cond_9
    iput v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->returnLoadUser:I
...
.method private isSensoryLib()Z
    ...
    const-string v1, "Error : Could not find libWakeUpSensory.so"
...
.method private setLanguage()V
    ...
    invoke-static {v2}, Lcom/samsung/voiceshell/WakeUpUtils;->ReadString(Ljava/lang/String;)Ljava/lang/String;
...
.method private setNewVersionLanguage()V
    ...
    invoke-static {v4}, Lcom/samsung/voiceshell/WakeUpUtils;->ReadString(Ljava/lang/String;)Ljava/lang/String;
...
.method protected InitializeEnroll()I
    ...
    invoke-virtual {v0, v1, v2}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->loadModels(Ljava/lang/String;S)I
    ...
    invoke-virtual {v0, v4}, Lcom/samsung/voiceshell/VoiceEngine;->setMode(I)V
...
.method protected TerminateEnroll()I
    ...
    invoke-virtual {v0}, Lcom/sensoryinc/fluentsoftsdk/SensoryUDTSIDEngine;->getSessionValueFPSV()J
...
.method protected sensoryProcessEnroll()I
    ...
    const-string v3, "sensoryProcessEnroll waiting.."

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    :cond_0
    iget-boolean v2, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isDelayFeature:Z

    if-eqz v2, :cond_1

    iget-boolean v2, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isStartNextEnroll:Z
    ...
    const-string v3, "sensoryProcessEnroll starting.."

    invoke-static {v2, v3}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    iput-boolean v7, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isStartNextEnroll:Z

    iget-boolean v2, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isRunning_enroll:Z

    if-nez v2, :cond_3

    iget-object v1, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->TAG:Ljava/lang/String;

    const-string v2, "sensoryProcessEnroll, don\'t start Enroll"
    ...
    iput-boolean v7, v0, Lcom/samsung/voiceshell/AudioRecordHaydn;->isPipeRecogEnrollSuccess:Z

    :cond_5
    iget-object v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->mDummyRecorder:Lcom/samsung/voiceshell/AudioRecordHaydn;

    iget-boolean v0, v0, Lcom/samsung/voiceshell/AudioRecordHaydn;->isPipeRecogEnrollSuccess:Z

    if-nez v0, :cond_6

    iget-boolean v0, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->sensoryUDTSIDThreadEnable:Z
...
.method public startVerify(I)I
    ...
    iput-boolean v10, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isAudioFocus:Z
    ...
    :cond_6
    iput-boolean v10, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->weHaveNoModel:Z
    ...
    invoke-interface {v1, v6, v4}, Lcom/samsung/voiceshell/VoiceEngineResultListener;->OnVerifyResult(IS)V
    ...
    :goto_6
    iput-boolean v10, p0, Lcom/samsung/voiceshell/WakeUpCmdRecognizer;->isSensoryInitialize:Z
